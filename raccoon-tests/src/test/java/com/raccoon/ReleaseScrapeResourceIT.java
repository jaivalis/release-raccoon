...
class ReleaseScrapeResourceIT {
    ...
    void releaseScrape_should_mark_hasNewRelease() throws InterruptedException, HeuristicRollbackException, SystemException, HeuristicMixedException, RollbackException, NotSupportedException {
